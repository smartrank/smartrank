 ...
 */
public class JsonReader implements SearchCriteriaReader {
    ...
    public JsonReader(final String fileName, final String criteria) throws IOException {
    ...
    private void readFile(final Reader reader) throws JsonParseException, JsonMappingException, IOException {

        final HashMap<String, Sample> specimens = new HashMap<>();
        final SmartRankImportFile importFile = new ObjectMapper().readValue(reader, SmartRankImportFile.class);
