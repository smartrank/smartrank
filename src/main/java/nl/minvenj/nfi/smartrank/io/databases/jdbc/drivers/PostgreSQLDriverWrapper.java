...
import static nl.minvenj.nfi.smartrank.io.databases.jdbc.drivers.Drivers.POSTGRESQL;
...
public class PostgreSQLDriverWrapper implements JDBCDriverWrapper {

    @Override
    public String getConnectString(final DatabaseConfiguration databaseConfiguration) {
        return "jdbc:postgresql://" + databaseConfiguration.getHostAndPort() + "/" + databaseConfiguration.getSchemaName();
    }

    @Override
    public String toString() {
        return POSTGRESQL.getName();
    }
    ...
    public Properties getProperties(final DatabaseConfiguration config) {
        ...
        props.put("connectTimeout", config.getSocketTimeout());
