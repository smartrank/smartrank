...
/**
 * Moves the currently selected item in the files list one position up.
 */
public final class MoveUpActionListener implements ActionListener {
     ...
     */
    public MoveUpActionListener(final BatchModePanel batchModePanel) {
