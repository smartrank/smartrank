...
/**
 * Opens a file chooser for population statistics files and stores the selected filename in the supplied component.
 */
public final class PopulationStatisticsBrowseActionListener implements ActionListener {
     ...
     * @param targetField the field that will receive the selected file name
     */
    public PopulationStatisticsBrowseActionListener(final BatchModePanel batchModePanel, final JTextField targetField) {
