...
/**
 * Sets the status of the selected item in the files table to {@link ScanStatus#PENDING}
 */
public final class RestartJobActionListener implements ActionListener {
     ...
     */
    public RestartJobActionListener(final BatchModePanel batchModePanel) {
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        _batchModePanel.getFilesTable().setValueAt(_batchModePanel.moveFileToFolder(file, _batchModePanel.getInputFolder()), selectedRow, 0);
