...
/**
 * Moves the currently selected item in the filestable to the top position.
 */
public final class MoveTopActionListener implements ActionListener {
     ...
     */
    public MoveTopActionListener(final BatchModePanel batchModePanel) {
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        if (selectedRow > 0) {
            _batchModePanel.getFilesTable().moveRow(selectedRow, 0);
        }
    }
}