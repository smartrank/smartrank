...
/**
 * Moves the currently selected item in the files table to the bottom position.
 */
public final class MoveBottomActionListener implements ActionListener {
     ...
     */
    public MoveBottomActionListener(final BatchModePanel batchModePanel) {
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        _batchModePanel.getFilesTable().moveRow(selectedRow, _batchModePanel.getFilesTable().getRowCount() - 1);
    }
}